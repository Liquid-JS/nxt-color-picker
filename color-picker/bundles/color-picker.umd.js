(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('color-picker', ['exports', '@angular/common', '@angular/core'], factory) :
    (factory((global['color-picker'] = {}),global.ng.common,global.ng.core));
    ...
    var ColorPickerComponent = /** @class */ (function () {
        ...
        ColorPickerComponent.propDecorators = {
            ...
            handleEsc: [{ type: i0.HostListener, args: ['document:keyup.esc', ['$event'],] }],
            handleEnter: [{ type: i0.HostListener, args: ['document:keyup.enter', ['$event'],] }]
        };
    ...
    var ColorPickerDirective = /** @class */ (function () {
        function ColorPickerDirective(injector, cfr, appRef, vcRef, elRef) {
            ...
            this.cpOpen = new i0.EventEmitter(true);
            this.cpClose = new i0.EventEmitter(true);
            this.cpCancel = new i0.EventEmitter(true);
            this.cpSelect = new i0.EventEmitter(true);
            this.cpColorChange = new i0.EventEmitter(false);
        ...
        ColorPickerDirective.propDecorators = {
            ...
            cpCloseClickOutside: [{ type: i0.Input }],
            ...
            cpOpen: [{ type: i0.Output }],
            cpClose: [{ type: i0.Output }],
            cpCancel: [{ type: i0.Output }],
            cpSelect: [{ type: i0.Output }],
            cpColorChange: [{ type: i0.Output }],
            cpPresetColorsChange: [{ type: i0.Output }],
            handleClick: [{ type: i0.HostListener, args: ['click',] }],
            handleFocus: [{ type: i0.HostListener, args: ['focus',] }],
    ...
    exports.Hsva = Hsva;
    exports.Rgba = Rgba;
    exports.parseColorMode = parseColorMode;
    exports.OutputFormat = OutputFormat;
    exports.AlphaChannel = AlphaChannel;
    exports.DialogPosition = DialogPosition;
    exports.DialogDisplay = DialogDisplay;
    exports.Position = Position;
    exports.ColorModeInternal = ColorModeInternal;
    exports.ɵc = ColorPickerDirective;
    exports.ɵb = SliderDirective;
...
//# sourceMappingURL=color-picker.umd.js.map