...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function distNxtColorPickerFesm2015NxtColorPickerJs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "AlphaChannel", function () {
      return AlphaChannel;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "ColorFormat", function () {
      return ColorFormat;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "DialogDisplay", function () {
      return DialogDisplay;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "DialogPosition", function () {
    ...
    __webpack_require__.d(__webpack_exports__, "OutputFormat", function () {
      return OutputFormat;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "calculateContrast", function () {
      return calculateContrast;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "calculateLuminance", function () {
      return calculateLuminance;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "calculateMinimumAlpha", function () {
      return calculateMinimumAlpha;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "compositeAlpha", function () {
      return compositeAlpha;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "compositeColors", function () {
      return compositeColors;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "compositeComponent", function () {
      return compositeComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "denormalizeRGBA", function () {
    ...
    __webpack_require__.d(__webpack_exports__, "hsla2hsva", function () {
      return hsla2hsva;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "hsva2hsla", function () {
      return hsva2hsla;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "hsvaToRgba", function () {
      return hsvaToRgba;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "rgbaToCmyk", function () {
      return rgbaToCmyk;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "rgbaToHsva", function () {
      return rgbaToHsva;
    });
    /* harmony export (binding) */
    ...
    function formatOutput(hsva, outputFormat, alphaChannel) {
      ...
      switch (outputFormat) {
        ...
        case OutputFormat.rgba:
          var rgba = denormalizeRGBA(hsvaToRgba(hsva));
        ...
        default:
          var allowHex8 = alphaChannel == AlphaChannel.always || alphaChannel == AlphaChannel.forced;
    ...
    var light = new Rgba(218, 218, 218, 1);
    var dark = new Rgba(34, 34, 34, 1);

    function opaqueSliderLight(background) {
      var cWhite = calculateContrast(light, new Rgba(background.r, background.g, background.b, 1));
      var cBlack = calculateContrast(dark, new Rgba(background.r, background.g, background.b, 1));
      return cWhite > cBlack;
    }

    function transparentSliderLight(background) {
      var bg = compositeColors(background, light);
      var cWhite = calculateContrast(light, new Rgba(bg.r, bg.g, bg.b, 1));
      var cBlack = calculateContrast(dark, new Rgba(bg.r, bg.g, bg.b, 1));
      return cWhite > cBlack;
    }
    ...
    function () {
      function ColorPickerComponent(elRef, cdRef, service) {
        ...
        this.dialogInputFields = [ColorFormat.hex, ColorFormat.rgba, ColorFormat.hsla];
      ...
      _createClass(ColorPickerComponent, [{
        ...
        value: function updateSize() {
          var w = this.dialogElement.nativeElement.offsetWidth;
          var h = this.dialogElement.nativeElement.offsetHeight;
        ...
        key: "setupDialog",
        value: function setupDialog(config) {
          ...
          this.cpIgnoredElements = [].concat(_toConsumableArray(Array.isArray(config.cpIgnoredElements) ? config.cpIgnoredElements : [config.cpIgnoredElements]), [this.elRef && this.elRef.nativeElement, config.elementRef && config.elementRef.nativeElement]).filter(function (e) {
            return !!e;
          });
          ...
          if (config.cpOutputFormat == OutputFormat.hex && config.cpAlphaChannel != AlphaChannel.always && config.cpAlphaChannel != AlphaChannel.forced) {
        ...
        value: function setColorFromString(value) {
          ...
          var hsva = stringToHsva(value, true);
        ...
        value: function onDragStart(slider) {
          if (this.callbacks) {
            this.callbacks.sliderDragStart({
              slider: slider,
              color: this.outputColor
            });
          }
        ...
        value: function onHexInput(value) {
          if (value == null) {
            ...
            var validHex = /^#([a-f0-9]{3}|[a-f0-9]{6}|[a-f0-9]{8})$/gi;
        ...
        value: function onAddPresetColor(value) {
        ...
        value: function onRemovePresetColor(value) {
        ...
        value: function updateColorPicker() {
          ...
          var hsla = hsva2hsla(this.hsva);
          var rgba = denormalizeRGBA(hsvaToRgba(this.hsva));
          var hue = denormalizeRGBA(hsvaToRgba(new Hsva(this.sliderH || this.hsva.h, 1, 1, 1)));
    ...
    function () {
      function ColorPickerDirective(injector, cfr, appRef, vcRef, elRef) {
        ...
        this._callbacks = {
          stateChanged: function stateChanged(state) {
            _this.cpToggleChange.emit(state);

            if (state) {
              _this.cpOpen.emit(_this.cpColor);
            } else {
              _this.cpClose.emit(_this.cpColor);
            }
          },
          colorChanged: function colorChanged(value) {
            var ignore = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
            _this.ignoreChanges = ignore;

            _this.cpColorChange.emit(value);
          },
          colorSelectCanceled: function colorSelectCanceled() {
            _this.cpColorSelectCancel.emit();
          },
          colorSelected: function colorSelected(value) {
            _this.cpColorSelect.emit(value);
          },
          inputChanged: function inputChanged(event) {
            _this.cpInputChange.emit(event);
          },
          sliderDragStart: function sliderDragStart(event) {
            _this.cpSliderDragStart.emit(event);
          },
          sliderChanged: function sliderChanged(event) {
            _this.cpSliderChange.emit(event);
          },
          sliderDragEnd: function sliderDragEnd(event) {
            _this.cpSliderDragEnd.emit(event);
          },
          presetColorsChanged: function presetColorsChanged(value) {
            _this.cpPresetColorsChange.emit(value);
          }
        };
        this.cpWidth = '230px';
        this.cpHeight = 'auto';
      ...
      _createClass(ColorPickerDirective, [{
        ...
        value: function setupDialog() {
          if (this.dialog) {
            this.dialog.setupDialog(Object.assign(Object.assign({}, this), {
        ...
        key: "ignoredElements",
        get: function get() {
          var ign = Array.isArray(this.cpIgnoredElements) ? this.cpIgnoredElements : [this.cpIgnoredElements];
          return ign.filter(function (el) {
            return !!el;
          });
        }
      }]);
    ...
    ColorPickerDirective.ɵdir = Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"])({
      ...
      hostBindings: function ColorPickerDirective_HostBindings(rf, ctx) {
        if (rf & 1) {
          ...
          })("change", function ColorPickerDirective_change_HostBindingHandler($event) {
            return ctx.handleInput($event);
          });
        }
      },
      ...
      outputs: {
        ...
        cpColorSelect: "cpColorSelect",
        cpColorSelectCancel: "cpColorSelectCancel",
    ...
    function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function onChangeColorCmyk(color) {
          var hsva = Object(nxt_color_picker__WEBPACK_IMPORTED_MODULE_1__["stringToHsva"])(color);

          if (hsva) {
            var rgba = Object(nxt_color_picker__WEBPACK_IMPORTED_MODULE_1__["hsvaToRgba"])(hsva);
        ...
        value: function onChangeColorHex8(color) {
          var hsva = Object(nxt_color_picker__WEBPACK_IMPORTED_MODULE_1__["stringToHsva"])(color, true);
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_16_listener($event) {
            return ctx.color1 = $event;
          })("cpOpen", function AppComponent_Template_input_cpOpen_16_listener($event) {
            return ctx.onEventLog("cpOpen", $event);
          })("cpClose", function AppComponent_Template_input_cpClose_16_listener($event) {
            return ctx.onEventLog("cpClose", $event);
          })("cpInputChange", function AppComponent_Template_input_cpInputChange_16_listener($event) {
            return ctx.onEventLog("cpInputChange", $event);
          })("cpSliderDragStart", function AppComponent_Template_input_cpSliderDragStart_16_listener($event) {
            return ctx.onEventLog("cpSliderDragStart", $event);
          })("cpSliderDragEnd", function AppComponent_Template_input_cpSliderDragEnd_16_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_35_listener($event) {
            return ctx.color17 = $event;
          })("cpOpen", function AppComponent_Template_input_cpOpen_35_listener($event) {
            return ctx.onEventLog("cpOpen", $event);
          })("cpClose", function AppComponent_Template_input_cpClose_35_listener($event) {
            return ctx.onEventLog("cpClose", $event);
          })("cpInputChange", function AppComponent_Template_input_cpInputChange_35_listener($event) {
            return ctx.onEventLog("cpInputChange", $event);
          })("cpSliderDragStart", function AppComponent_Template_input_cpSliderDragStart_35_listener($event) {
            return ctx.onEventLog("cpSliderDragStart", $event);
          })("cpSliderDragEnd", function AppComponent_Template_input_cpSliderDragEnd_35_listener($event) {
            return ctx.onEventLog("cpSliderDragEnd", $event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_47_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_59_listener($event) {
            return ctx.color3 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_62_listener($event) {
            return ctx.color4 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_74_listener($event) {
            return ctx.color5 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_span_cpColorChange_86_listener($event) {
            return ctx.color6 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_99_listener($event) {
            return ctx.color7 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_111_listener($event) {
            return ctx.color8 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_123_listener($event) {
            return ctx.color9 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_135_listener($event) {
            ctx.cmykColor = ctx.onChangeColorCmyk($event);
            return ctx.color10 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_160_listener($event) {
            return ctx.color11 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_172_listener($event) {
            return ctx.color13 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpToggleChange", function AppComponent_Template_input_cpToggleChange_184_listener($event) {
            return ctx.toggle = $event;
          })("cpColorChange", function AppComponent_Template_input_cpColorChange_184_listener($event) {
            return ctx.color12 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_187_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_206_listener($event) {
            return ctx.color14 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_208_listener($event) {
            return ctx.color13 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_210_listener($event) {
            ctx.rgbaText = ctx.onChangeColorHex8($event);
            return ctx.color16 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_input_cpColorChange_212_listener($event) {
            return ctx.color15 = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cpColorChange", function AppComponent_Template_span_cpColorChange_224_listener($event) {
            return ctx.arrayColors[ctx.selectedColor] = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_div_click_226_listener($event) {
            return ctx.selectedColor = "color1";
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_div_click_227_listener($event) {
            return ctx.selectedColor = "color2";
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_div_click_228_listener($event) {
            return ctx.selectedColor = "color3";
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_div_click_229_listener($event) {
            return ctx.selectedColor = "color4";
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_div_click_230_listener($event) {
            return ctx.selectedColor = "color5";
          });
        ...
        if (rf & 2) {
          var _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](185);

          var _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](188);
      ...
      directives: [nxt_color_picker__WEBPACK_IMPORTED_MODULE_1__["ColorPickerDirective"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], nxt_color_picker__WEBPACK_IMPORTED_MODULE_2__["ColorPickerModule"]]]
    });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Development\nxt-color-picker\projects\demo\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
